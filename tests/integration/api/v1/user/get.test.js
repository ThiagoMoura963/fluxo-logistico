  ...
  describe("Default user", () => {
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "8ea6744ea1a0bba2f2f1ea0a9d8d9530b063dc66c8f433fc52f4b5cee55a588eb6fa7e51cba9d34ce1c432c1ae08840a";
    ...
    test("With session expiring in 10 minutes", async () => {
      const TEN_MINUTES_IN_MILLISECONDS = 10 * 60 * 1000;
      jest.useFakeTimers({
        now: new Date(
          Date.now() -
            (session.EXPIRATION_IN_MILLISECONDS - TEN_MINUTES_IN_MILLISECONDS),
        ),
      });
